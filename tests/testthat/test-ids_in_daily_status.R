describe("All IDs defined in list are in daily status", {
  ...
  incorrect_daily_status_path <- "/workdir/tests/data/incorrect_daily_status.csv"
  ...
  it("Check all ID's are in ids list", {
    ...
    expect_false(check_all_ids_in_list_are_in_daily_status(incorrect_daily_status_path, traps_list_path))
  })
})
